...
const Produit = () => {
  ...
  useEffect(() => {
    ...
    const fetchProduitCount = async () => {
      try{
          const response = await axios.get('http://localhost:3000/produits/produits/count');
          setProduitCount(response.data.produitCount)
      }catch(error){
          console.error('error fetching produit count:', error)
      }
    }

    const fetchOrderCount = async () => {
      try{
          const response = await axios.get('http://localhost:3000/orders/order/count');
    ...
    <div className="flex flex-wrap -mx-6">
        ...
        <div className="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
            <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-slate-100">
                ...
                <div className="mx-5">
                    <h4 className="text-2xl font-semibold text-gray-700">{produitCount !== null ? produitCount : 'Loading...'}</h4>
        ...
        <div className="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
            <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-slate-100">
                ...
                <div className="mx-5">
                    <h4 className="text-2xl font-semibold text-gray-700">{orderCount !== null ? orderCount : 'Loading...'}</h4>

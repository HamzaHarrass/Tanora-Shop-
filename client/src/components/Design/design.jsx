...
function AddText(){
    return <>
        ...
        <div className="flex items-center justify-center py-3">
            ...
            <input type="color" className="mx-4" />
        </div>
        <div className="flex items-center justify-center py-2">
            <label htmlFor="text-color" className="text-lg font-semibold">
                Font : 
            </label>
            <select type="color" className="mx-4 p-2 px-6 shadow-lg  rounded-lg" >
                <option value="">Open Sans</option>
                <option value="">Font 1 fontsi</option>
                <option value="">Font 1 fontsi</option>
                <option value="">Font 1 fontsi</option>
                <option value="">Font 1 fontsi</option>
            </select>
      ...
      <section className="flex-1 px-10 flex gap-10">
        <div className="flex flex-col gap-4 w-max">
            <button onClick={()=>setActive('Item')} className="py-6 flex flex-col items-center gap-4 shadow-lg bg-white hover:bg-gray-100">
                 <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 640 512" height="65" width="65" xmlns="http://www.w3.org/2000/svg"><path d="M631.2 96.5L436.5 0C416.4 27.8 371.9 47.2 320 47.2S223.6 27.8 203.5 0L8.8 96.5c-7.9 4-11.1 13.6-7.2 21.5l57.2 114.5c4 7.9 13.6 11.1 21.5 7.2l56.6-27.7c10.6-5.2 23 2.5 23 14.4V480c0 17.7 14.3 32 32 32h256c17.7 0 32-14.3 32-32V226.3c0-11.8 12.4-19.6 23-14.4l56.6 27.7c7.9 4 17.5.8 21.5-7.2L638.3 118c4-7.9.8-17.6-7.1-21.5z"></path></svg>
        ...
        <div>
            <div className="shadow-lg p-5 rounded-2xl flex justify-center"> <img className="h-32" src="https://storage.googleapis.com/ecommerce-main-e0cf7.appspot.com/products/62901d5f2fdf190016cf79ce/front.png" alt="" /></div>
            <div className="shadow-lg p-5 rounded-2xl flex flex-col gap-2">
                <button className="flex justify-center py-4 hover:bg-gray-200">
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" color="" height="40" width="40" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zm2.46-7.12l1.41-1.41L12 12.59l2.12-2.12 1.41 1.41L13.41 14l2.12 2.12-1.41 1.41L12 15.41l-2.12 2.12-1.41-1.41L10.59 14l-2.13-2.12zM15.5 4l-1-1h-5l-1 1H5v2h14V4z"></path></svg>
                </button>
                <div className="flex gap-2">
                    <button className="hover:bg-gray-200">
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="30" width="30" xmlns="http://www.w3.org/2000/svg"><path d="m5.005 15.995 4-4-4-4v3h-3v2h3zm14-5v-3l-4 4 4 4v-3h3v-2h-2.072zm-8 7h2v3h-2zm0-5h2v3h-2zm0-5h2v3h-2zm0-5h2v3h-2z"></path></svg>
                    </button>
                    <button className="hover:bg-gray-200">
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="30" width="30" xmlns="http://www.w3.org/2000/svg"><path d="m5.005 15.995 4-4-4-4v3h-3v2h3zm14-5v-3l-4 4 4 4v-3h3v-2h-2.072zm-8 7h2v3h-2zm0-5h2v3h-2zm0-5h2v3h-2zm0-5h2v3h-2z"></path></svg>
                    </button>
